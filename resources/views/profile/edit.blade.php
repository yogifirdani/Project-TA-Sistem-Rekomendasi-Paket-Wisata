        ...
        <div class="bg-white/10 backdrop-blur-md border border-white/20 shadow-2xl rounded-[2rem] overflow-hidden flex flex-col md:flex-row mx-auto">
            ...
            <aside class="w-full md:w-64 bg-white/5 border-r border-white/10 p-6 flex flex-col items-center">
                ...
                <nav class="w-full space-y-2">
                    <a href="{{ route('profile') }}" class="flex items-center gap-3 px-5 py-3 rounded-xl transition-all duration-300 text-white/60 hover:bg-white/5 hover:text-white">
                        <i class="ion-ios-arrow-back text-lg"></i>
                        <span class="text-xs font-semibold">Kembali ke Profil</span>
                    </a>
                </nav>
            </aside>
            ...
            <main class="flex-1 p-6 md:p-10 relative">
                ...
                <form action="{{ route('profile.update') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="group">
                            <label class="text-white/40 text-[10px] font-bold uppercase tracking-wider mb-1.5 block ml-1">Username / Nama</label>
                ...
                <form action="{{ route('profile.password') }}" method="POST" class="space-y-6">
                    ...
                    <div class="group">
                        <label class="text-white/40 text-[10px] font-bold uppercase tracking-wider mb-1.5 block ml-1">Password Saat Ini</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="group">
                            <label class="text-white/40 text-[10px] font-bold uppercase tracking-wider mb-1.5 block ml-1">Password Baru</label>
                            <input type="password" name="password" required placeholder="Minimal 8 karakter"
                                class="w-full bg-white/5 border border-white/10 px-4 py-3 rounded-xl text-white text-sm font-medium focus:outline-none focus:border-yellow-400/60 focus:bg-white/10 transition-all shadow-inner placeholder-white/20">
                        </div>

                        <div class="group">
                            <label class="text-white/40 text-[10px] font-bold uppercase tracking-wider mb-1.5 block ml-1">Konfirmasi Password Baru</label>
